...
class AuthenticationController extends GetxController
{
  ...
  captureImageFromPhoneCamera() async
  {
    ...
    if(imageFile != null)
    {
      Get.snackbar("Profile Image", "you have successfully successfully captured your profile image using camera.");
    }
  ...
  async {
    ...
    {
      Get.snackbar("Account Creating Unsuccessful", "Error occurred: $errorMsg");
    }
  }
